...
const TaskItem = () => {
    return (
        <div className="col s4"><div className="card-panel hoverable" style={{borderRadius:"10px", backgroundColor: "rgb(32, 164, 243)", padding:"10px", height:"200px",  overflow:"auto"}}>
            <p className="black-text" style={{marginTop:"5px", marginBottom:"5px"}}>Title</p>
            <Link to="/task">
                <h5 className="white-text" style={{marginTop:"5px", marginBottom:"5px",fontFamily: 'Philosopher sans-serif'}}>Title to my task</h5>
            </Link>
