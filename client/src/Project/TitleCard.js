      ...
      <div className="col s4" style={{ height: "100%" }}>
        ...
        >
          ...
          <div className="row" style={{ margin: "0px", marginTop: "40px" }}>
            <Link to="/team" className="white-text">
              Click to View Team
              <i className="material-icons left white-text">visibility</i>
            </Link>
            <a
              href="#edit-project-modal"
              className="white-text right modal-trigger"
            >
