...
const ProjectItem = () => {
    return (
        ...
        <div className="col s4"><div className="card-panel hoverable" style={custom}>
            <p className="black-text" style={{marginTop:"5px", marginBottom:"5px"}}>Title</p>
            <Link to="/project">
                <h5 className="white-text" style={{marginTop:"5px", marginBottom:"5px",fontFamily: 'Philosopher sans-serif'}}>Title to my project</h5>
            </Link>
